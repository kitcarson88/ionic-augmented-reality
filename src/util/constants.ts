export const constants = {
    ...
    GPS_MAXIMUM_AGE: 5000, //DEBUG
    GPS_ENABLE_HIGH_ACCURACY: true,
    GPS_TIMEOUT_ENABLED: true,
    GPS_TIMEOUT: 5000, //DEBUG
        //Accelerometer relevation options
    ACCELEROMETER_FREQUENCY: 5000, //DEBUG
        //Gyroscope relevation options
    GYROSCOPE_FREQUENCY: 5000, //DEBUG
        //Magnetometer relevation options
    MAGNETOMETER_MOCKED: true, //DEBUG
    MAGNETOMETER_MOCK_FREQUENCY: 5000,    //ONLY FOR DEBUG
        //Fusion sensors options
    FUSION_SENSOR_INIT_DELAY: 3000,
    FUSION_SENSOR_FREQUENCY: 10000,    //DEBUG     //This value might be higher than accelerometer and gyroscope frequency
